...
const ProductCard = ({ productData, offer }) => {
  return (
    <div className='min-w-[300px] w-[300px] py-4 border-[1px] bg-white border-gray-300 flex flex-col items-center relative'>
      ...
      <div className='w-full flex flex-col gap-2 mt-2 px-4'>
        <Link to={`/products/${productData.id}`}>
          <p className='h-14 font-josefina font-semibold text-xl line-clamp-2 text-palette-dark transition-color duration-700 ease-in-out hover:text-palette-lightblue'>
            {productData.title}
          </p>
        </Link>
